    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            /* writer.WriteFunction(model.GetGaussLaggerList, "GetGaussLaggerList", true);
             ...
             writer.Write2DFunction(model.RestoreImage(model.Hankel), "RestoreHankel", true);
             writer.Write2DFunction(model.RestoreImage(model.Hankel), "RestoreHankel", false);
             writer.Write2DFunction(fourier.FftValues(), "FftValues", true);
             writer.Write2DFunction(fourier.FftValues(), "FftValues", false);
            */
            fourier.FftValues();
            model.RestoreImage(model.Hankel);
            Console.ReadLine();
            /*
